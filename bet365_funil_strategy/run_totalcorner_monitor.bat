...
cls
echo.
echo Monitor Ao Vivo (Modo Gratuito) - Estrategia do Funil
echo ========================================================
echo.
...
echo.
echo Iniciando monitor continuo com feed local...
echo Requer atualizacao do feed a cada 120s para considerar ao vivo.
echo.
